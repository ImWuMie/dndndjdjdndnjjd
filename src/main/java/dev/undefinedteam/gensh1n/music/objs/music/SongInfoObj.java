...
import dev.undefinedteam.gensh1n.music.objs.api.music.trialinfo.freeTrialInfo;
...
public class SongInfoObj {
    ...
    public SongInfoObj(String Author, String Name, String ID, String Alia, String Al, int Length, String picUrl, boolean isTrial, freeTrialInfo trialInfo) {
        this.author = Author;
        this.name = Name;
        this.id = ID;
        this.alia = Alia;
    ...
    public String getInfo() {
        String info = "%MusicName% | %MusicAuthor% | %MusicAl% | %MusicAlia% | by: %PlayerName%";
