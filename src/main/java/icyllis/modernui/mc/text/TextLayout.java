...
import dev.undefinedteam.gensh1n.render.Mesh;
...
public class TextLayout {
    ...
    public static final TextLayout EMPTY = new TextLayout(new char[0], new int[0], new float[0],
        null, new Font[0], new float[0], new int[0], new int[]{0}, 0f, 0, false, false, 2, ~0) {
        @Nonnull
        @Override
        TextLayout get() {
    ...
    public float drawText(@Nonnull final Matrix4f matrix,
        ...
        final float baseline = top + this.computeFontSize(mCreatedResLevel) - this.mFontSize / 8f;
        ...
        for (int i = 0, e = glyphs.length; i < e; i++) {
            ...
            if ((bits & CharacterStyle.ANY_BITMAP_REPLACEMENT) != 0) {
                ...
                if (getFont(i) instanceof BitmapFont bitmapFont) {
                    ...
                    ascent = (int) (computeFontSize(mCreatedResLevel) - this.mFontSize / 8f);
                }
    ...
    public void drawTextOutline(@Nonnull Matrix4f matrix,
        ...
        final float baseline = top + computeFontSize((int) resLevel) - this.mFontSize / 8f;
