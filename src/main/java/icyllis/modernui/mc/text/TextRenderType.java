...
public class TextRenderType extends RenderLayer {
    ...
    private static final BufferAllocator sFirstSDFFillAllocator = new BufferAllocator(131072);

    private static TextRenderType sFirstSDFStrokeType;
    private static final BufferAllocator sFirstSDFStrokeAllocator = new BufferAllocator(131072);
    ...
    private static TextRenderType makeSDFStrokeType(int texture) {
        ...
        if (sFirstSDFStrokeType == null) {
            ...
            if (TextLayoutEngine.sUseTextShadersInWorld) {
                try {
                    /*( MinecraftClient.getInstance().getBufferBuilders().getEntityVertexConsumers()).getLayerBuffers()
